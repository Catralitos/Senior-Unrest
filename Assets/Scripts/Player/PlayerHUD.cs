...
namespace Player
{
    ...
    public class PlayerHUD : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            trapsText.text = PlayerEntity.Instance.traps.CurrentAmountOfTraps() + "/" +
                             PlayerEntity.Instance.traps.trapSlots;
            goldText.text = PlayerEntity.Instance.inventory.CurrentGold.ToString();
            turnsLeftImage.fillAmount = 1.0f - 1.0f * TurnManager.Instance.turnsBeforeSleepDrop /
                TurnManager.Instance.turnsForSleepDrop;
